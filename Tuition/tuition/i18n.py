...
STRINGS = {
    ...
    "linked_teacher": {"en": "Linked teacher profile", "zh": "绑定老师档案", "ms": "Profil guru dipautkan"},
    "linked_teacher_hint": {
        "en": "Only needed to auto-calculate your commission below — leave blank if you teach this class yourself.",
        "zh": "只是用来自动算下面的佣金 —— 如果是你自己教，留空就好。",
        "ms": "Hanya untuk mengira komisen di bawah secara automatik — biar kosong jika anda sendiri mengajar.",
    },
    "commission": {"en": "Teacher Commission", "zh": "教师佣金", "ms": "Komisen Guru"},
    "commission_hint": {
        "en": "You pay this teacher a fixed rate per lesson; the difference from what's billed is what you keep.",
        "zh": "你付这位老师固定的每堂费，跟收学生的差额就是你赚的。",
        "ms": "Anda bayar guru ini kadar tetap sekelas; bezanya dengan yuran yang dikenakan ialah yang anda simpan.",
    },
    "pay_per_lesson": {"en": "Pay per lesson", "zh": "每堂付老师", "ms": "Bayaran sekelas"},
    "teacher_payout": {"en": "Owed to teacher this month", "zh": "这个月应付老师", "ms": "Perlu dibayar kepada guru bulan ini"},
    "my_commission": {"en": "My commission this month", "zh": "这个月我赚的佣金", "ms": "Komisen saya bulan ini"},
    "commission_no_teacher": {
        "en": "This teacher isn't paid per lesson (see their profile's Rate) — commission needs that to calculate.",
        "zh": "这位老师的收费不是「按堂」（去老师档案改一下） —— 佣金要按堂收费才能算。",
        "ms": "Guru ini tidak dibayar sekelas (lihat Kadar dalam profil mereka) — komisen perlukan itu untuk dikira.",
    },
    ...
    # ── teachers ──
    "nav_teachers": {"en": "Teachers", "zh": "老师", "ms": "Guru"},
    "add_teacher": {"en": "Add Teacher", "zh": "新增老师", "ms": "Tambah Guru"},
    "edit_teacher": {"en": "Edit Teacher", "zh": "编辑老师", "ms": "Sunting Guru"},
    "teacher_info": {"en": "Teacher Information", "zh": "老师资料", "ms": "Maklumat Guru"},
    "subjects_taught": {"en": "Subjects taught", "zh": "可教科目", "ms": "Subjek diajar"},
    "subjects_hint": {"en": "Click to pick one or more — type a new subject below to add it.",
                      "zh": "点选一个或多个 —— 没有的话在下面输入新增。",
                      "ms": "Klik untuk pilih satu atau lebih — taip subjek baharu di bawah untuk menambah."},
    "levels_taught": {"en": "Grades / levels", "zh": "可教年级", "ms": "Tingkatan / tahap"},
    "levels_hint": {"en": "Click to pick one or more — type a new grade below to add it.",
                    "zh": "点选一个或多个 —— 没有的话在下面输入新增。",
                    "ms": "Klik untuk pilih satu atau lebih — taip tingkatan baharu di bawah untuk menambah."},
    "teaching_languages": {"en": "Teaching languages", "zh": "教学语言", "ms": "Bahasa pengajaran"},
    "experience_years": {"en": "Years of experience", "zh": "教学经验（年）", "ms": "Tahun pengalaman"},
    "years_short": {"en": "yr", "zh": "年", "ms": "thn"},
    "rate": {"en": "Rate", "zh": "收费", "ms": "Kadar"},
    "rate_unit": {"en": "per", "zh": "每", "ms": "setiap"},
    "ru_hour": {"en": "hour", "zh": "小时", "ms": "jam"},
    "ru_lesson": {"en": "lesson", "zh": "堂", "ms": "kelas"},
    "ru_month": {"en": "month", "zh": "月", "ms": "bulan"},
    "bio": {"en": "Bio / notes", "zh": "简介 / 备注", "ms": "Bio / nota"},
    "availability": {"en": "Weekly availability", "zh": "每周可上课时间", "ms": "Ketersediaan mingguan"},
    "availability_hint": {"en": "Tick the days this teacher can teach. Leave the time blank if flexible.",
                          "zh": "勾选老师可以上课的日子。时间灵活的话可以留空。",
                          "ms": "Tanda hari guru boleh mengajar. Biar masa kosong jika fleksibel."},
    "no_availability": {"en": "No availability set", "zh": "未设置时间", "ms": "Tiada ketersediaan"},
    "any_time": {"en": "any time", "zh": "任何时间", "ms": "bila-bila masa"},
    "match_teacher": {"en": "Match a Teacher", "zh": "匹配老师", "ms": "Padan Guru"},
    "match_hint": {"en": "Enter what the new student needs — the best-fitting teachers are ranked below.",
                   "zh": "输入新生的需求 —— 下面会列出最合适的老师。",
                   "ms": "Masukkan keperluan pelajar baharu — guru paling sesuai disenaraikan di bawah."},
    "preferred_day": {"en": "Preferred day", "zh": "希望的日子", "ms": "Hari pilihan"},
    "preferred_time": {"en": "Preferred time", "zh": "希望的时间", "ms": "Masa pilihan"},
    "any_day": {"en": "Any day", "zh": "任何日子", "ms": "Mana-mana hari"},
    "find_matches": {"en": "Find matches", "zh": "查找", "ms": "Cari padanan"},
    "match_score": {"en": "Match", "zh": "匹配度", "ms": "Padanan"},
    "why_match": {"en": "Why", "zh": "匹配原因", "ms": "Sebab"},
    "m_subject": {"en": "Subject", "zh": "科目", "ms": "Subjek"},
    "m_level": {"en": "Grade", "zh": "年级", "ms": "Tingkatan"},
    "m_day": {"en": "Day", "zh": "日子", "ms": "Hari"},
    "m_time": {"en": "Time", "zh": "时间", "ms": "Masa"},
    "m_language": {"en": "Language", "zh": "语言", "ms": "Bahasa"},
    "no_matches": {"en": "No teachers match yet — add teachers or widen the criteria.",
                   "zh": "还没有匹配的老师 —— 新增老师或放宽条件。",
                   "ms": "Tiada guru sepadan — tambah guru atau longgarkan kriteria."},
    "teachers_none": {"en": "No teachers yet.", "zh": "还没有老师。", "ms": "Belum ada guru."},
    "st_inactive_teacher": {"en": "Inactive", "zh": "暂停", "ms": "Tidak Aktif"},

    # ── teacher screening / basic-info intake ──
    "screening_info": {"en": "Basic Info (screening)", "zh": "基本资料（面试用）", "ms": "Maklumat Asas (temu duga)"},
    "experience_summary": {"en": "Experience", "zh": "经验", "ms": "Pengalaman"},
    "experience_summary_hint": {"en": "e.g. 1-to-1 primary English / Math / Science tutoring",
                                "zh": "例如：1对1 小学 英文/数学/科学补习",
                                "ms": "cth: Tuisyen 1-ke-1 sekolah rendah Bahasa Inggeris / Matematik / Sains"},
    "current_work": {"en": "Current job / university", "zh": "目前工作/大学", "ms": "Pekerjaan semasa / universiti"},
    "academic_results": {"en": "Academic results (if a university student)", "zh": "成绩（如果是大学生）", "ms": "Keputusan akademik (jika pelajar universiti)"},
    "subjects_notes": {"en": "Teaching breakdown notes", "zh": "科目/年级补充说明", "ms": "Nota Pecahan Pengajaran"},
    "subjects_notes_hint": {
        "en": "For combinations the pickers above can't quite capture, e.g. \"Primary - All subjects; Form 1-3 - Math/Science\".",
        "zh": "上面的选项没法完全表达的组合，例如：「小学-All, Form 1-3-Math/Science」。",
        "ms": "Untuk kombinasi yang tidak dapat diwakili sepenuhnya oleh pilihan di atas, cth: \"Rendah - Semua subjek; Tingkatan 1-3 - Matematik/Sains\".",
    },
    "asking_rate": {"en": "Asking rate (RM/hour, at interview)", "zh": "理想时薪 (RM/小时，面试时提出)", "ms": "Kadar Dikehendaki (RM/jam, semasa temu duga)"},
    "asking_rate_hint": {"en": "What they said they want — separate from Rate above, which is what you actually pay them once hired.",
                         "zh": "面试时他们说想要的 —— 跟上面「收费」是两回事，那个是你实际付给他们的。",
                         "ms": "Apa yang mereka mahu semasa temu duga — berasingan daripada Kadar di atas, iaitu apa yang anda bayar selepas diambil bekerja."},
    "rate_range_to": {"en": "to", "zh": "至", "ms": "hingga"},
    "has_tablet": {"en": "Has a tablet?", "zh": "有平板吗？", "ms": "Ada tablet?"},
    "yes": {"en": "Yes", "zh": "有", "ms": "Ya"},
    "no": {"en": "No", "zh": "没有", "ms": "Tiada"},
    "unknown": {"en": "Not asked", "zh": "还没问", "ms": "Belum ditanya"},
    "looking_for_teacher": {"en": "Looking for a teacher?", "zh": "需要配老师吗？", "ms": "Mencari guru?"},
    "looking_for_teacher_hint": {
        "en": "Fill this in and saving jumps straight to matching teachers for this student.",
        "zh": "填了之后，保存会直接跳去帮这个学生匹配老师。",
        "ms": "Isi ini dan simpan akan terus ke halaman padanan guru untuk pelajar ini.",
    },
    "matching_for": {"en": "Matching teachers for", "zh": "正在为以下人选匹配老师：", "ms": "Memadankan guru untuk"},
    "find_teacher_matches": {"en": "Find a teacher", "zh": "找老师", "ms": "Cari guru"},
    "back_to_student": {"en": "Back to student", "zh": "返回学生", "ms": "Kembali ke pelajar"},

    # ── prospects (still deciding / trying us out — matching only) ──
    "nav_prospects": {"en": "Inquiries", "zh": "咨询中", "ms": "Pertanyaan"},
    "add_prospect": {"en": "Add Inquiry", "zh": "新增咨询", "ms": "Tambah Pertanyaan"},
    "prospects_none": {"en": "No inquiries yet.", "zh": "还没有咨询。", "ms": "Belum ada pertanyaan."},
    "prospects_hint": {"en": "People still deciding or trying us out — just enough to match them to a teacher. Once they're in, hand them off to a real student record.",
                       "zh": "还在了解或试课的人 —— 只需要足够的资料来配老师。确定要来了，就转成正式学生。",
                       "ms": "Orang yang masih memutuskan atau mencuba — cukup untuk dipadankan dengan guru. Apabila sahih, jadikan pelajar rasmi."},
    "name": {"en": "Name", "zh": "姓名", "ms": "Nama"},
    "back_to_prospect": {"en": "Back to inquiry", "zh": "返回咨询", "ms": "Kembali ke pertanyaan"},
    "pr_open": {"en": "In progress", "zh": "了解中", "ms": "Dalam proses"},
    "pr_converted": {"en": "Became a student", "zh": "已成为学生", "ms": "Menjadi pelajar"},
    "pr_dropped": {"en": "Didn't proceed", "zh": "没有下文", "ms": "Tidak diteruskan"},
    "pr_ready": {"en": "Ready to enrol?", "zh": "决定要报名了吗？", "ms": "Sedia untuk mendaftar?"},
    "pr_convert": {"en": "Convert to Student", "zh": "转为正式学生", "ms": "Jadikan Pelajar"},
    "pr_mark_dropped": {"en": "Mark as didn't proceed", "zh": "标记为没有下文", "ms": "Tandakan tidak diteruskan"},
    "pr_reopen": {"en": "Reopen — still deciding", "zh": "重新开放 — 还在了解", "ms": "Buka semula — masih memutuskan"},
    "pr_from_prospect": {"en": "Converting from inquiry", "zh": "由咨询转来", "ms": "Ditukar daripada pertanyaan"},
    "subjects_wanted": {"en": "Subject(s) wanted", "zh": "想要补的科目", "ms": "Subjek yang dikehendaki"},
    "subjects_wanted_hint": {"en": "Click to pick one or more — type a new subject below to add it.",
                             "zh": "点选一个或多个 —— 没有的话在下面输入新增。",
                             "ms": "Klik untuk pilih satu atau lebih — taip subjek baharu di bawah untuk menambah."},
    "prospect_availability_hint": {"en": "When they're free — for a trial lesson or the regular class alike. Leave the time blank if flexible.",
                                   "zh": "他们方便的时间 —— 试课或正式上课都适用。时间灵活的话可以留空。",
                                   "ms": "Bila mereka lapang — untuk kelas percubaan atau kelas tetap. Biar masa kosong jika fleksibel."},
    "budget": {"en": "Budget", "zh": "学费预算", "ms": "Bajet Yuran"},
    "budget_hint": {"en": "What they're expecting to pay, if mentioned.", "zh": "如果有提到，他们预期的学费。", "ms": "Jangkaan bayaran mereka, jika disebut."},
    "start_date_hint": {"en": "When they'd like to start.", "zh": "他们希望几时开始上课。", "ms": "Bila mereka mahu mula."},
    "prospect_notes": {"en": "Requirements / notes", "zh": "要求 / 备注", "ms": "Keperluan / Nota"},
    "chip_add_placeholder": {"en": "Type a new one…", "zh": "输入新的…", "ms": "Taip yang baharu…"},
    "avail_count": {"en": "How many times a week", "zh": "每周几次", "ms": "Berapa kali seminggu"},
    "avail_flexible": {"en": "Not decided / flexible", "zh": "未定 / 灵活", "ms": "Belum pasti / fleksibel"},
    "avail_pick_day": {"en": "Day", "zh": "星期", "ms": "Hari"},
    "parent_info": {"en": "Parent / Guardian", "zh": "父母 / 监护人资料", "ms": "Maklumat Ibu Bapa / Penjaga"},
    "assigned_teacher": {"en": "Assigned teacher", "zh": "负责老师", "ms": "Guru bertanggungjawab"},
    "assigned_teacher_hint": {
        "en": "Tentative — who'd likely teach this student. Their rate is shown on the inquiry page for a rough commission estimate.",
        "zh": "暂定 —— 大概会是哪位老师教。老师的收费会显示在咨询详情页，粗略估一下你的佣金。",
        "ms": "Sementara — guru yang berkemungkinan mengajar. Kadar mereka dipaparkan di halaman pertanyaan untuk anggaran komisen kasar.",
    },
    "commission_estimate": {"en": "Estimated commission", "zh": "预估佣金", "ms": "Anggaran komisen"},
    "commission_estimate_hint": {"en": "Budget − the assigned teacher's rate (same unit).",
                                 "zh": "预算 − 负责老师的收费（单位相同）。",
                                 "ms": "Bajet − kadar guru yang ditugaskan (unit sama)."},
    "commission_estimate_mismatch": {
        "en": "Set the budget's unit to match the teacher's rate unit to estimate a commission.",
        "zh": "把预算单位设成跟老师收费单位一样，才能预估佣金。",
        "ms": "Padankan unit bajet dengan unit kadar guru untuk menganggarkan komisen.",
    },
    "teacher_rate": {"en": "Teacher's rate", "zh": "老师收费", "ms": "Kadar guru"},
    "no_options_yet": {"en": "Nothing added yet — type one below.", "zh": "还没有选项 —— 在下面输入新增。", "ms": "Belum ada pilihan — taip di bawah."},
    "trial_class_time": {"en": "Trial class time", "zh": "试课时间", "ms": "Masa Kelas Percubaan"},
    "trial_class_time_hint": {"en": "The specific slot for a trial lesson — separate from their regular weekly availability above.",
                              "zh": "试课的具体时间 —— 跟上面每周固定可上课时间是两回事。",
                              "ms": "Slot khusus untuk kelas percubaan — berasingan daripada ketersediaan mingguan tetap di atas."},
    "trial_time": {"en": "Trial time", "zh": "试课时间", "ms": "Masa Percubaan"},
}
